...
class SwapManager(Logger):
    ...
    async def normal_swap(
        ...
        """send on-chain BRM, receive on Lightning
    ...
    def server_create_swap(self, request):
        ...
        if req_type == 'reversesubmarine':
            ...
            raise Exception('Deprecated API. Please upgrade your version of Bitraam')
        else:
...
class HttpTransport(SwapServerTransport):
    ...
    async def get_pairs_just_once(self) -> None:
        ...
        try:
            ...
            fees = response['pairs']['BRM/BRM']['fees']
            limits = response['pairs']['BRM/BRM']['limits']
            pairs = SwapFees(
...
class NostrTransport(SwapServerTransport):
    ...
    async def publish_offer(self, sm: 'SwapManager') -> None:
        ...
        tags = [['d', f'bitraam-swapserver-{self.NOSTR_EVENT_VERSION}'],
    ...
    async def _get_pairs_loop(self):
        ...
        query = {
            ...
            "limit": 10,
            "#d": [f"bitraam-swapserver-{self.NOSTR_EVENT_VERSION}"],
        ...
        async for event in self.relay_manager.get_events(query, single_event=False, only_stored=False):
            try:
                ...
                continue
            if tags.get('d') != f"bitraam-swapserver-{self.NOSTR_EVENT_VERSION}":
                continue
