...
This code connects the public USB API and Bitraam. Leverages all
the good work that's been done by the Bitraam team to support
hardware wallets.
...
to Bitraam and it will fetch history, blockchain details and then
...
Transaction > From File in Bitraam or really any tool.
...
- I find this command useful (at top level) ... but I'm a VIM user.
    ...
    ctags -f .tags bitraam `find . -name ENV -prune -o -name \*.py`
