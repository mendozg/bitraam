...
from bitraam.hw_wallet.plugin import is_any_tx_output_on_change_branch, trezor_validate_op_return_output_and_get_data
...
class KeepKeyPlugin(HW_PluginBase):
    ...
    def get_keepkey_input_script_type(self, bitraam_txin_type: str):
    ...
    def get_keepkey_output_script_type(self, bitraam_txin_type: str):
        if bitraam_txin_type in ('p2wpkh', 'p2wsh'):
            ...
            if txin.is_coinbase_input():
                ...
                if for_sig:
                    ...
                    if multi := desc.get_simple_multisig():
                        ...
                        multisig = None
                    script_type = self.get_keepkey_input_script_type(desc.to_legacy_bitraam_script_type())
                    txinputtype = self.types.TxInputType(
    ...
    def tx_outputs(self, tx: PartialTransaction, *, keystore: 'KeepKey_KeyStore'):
        ...
        def create_output_by_derivation():
            ...
            assert desc
            script_type = self.get_keepkey_output_script_type(desc.to_legacy_bitraam_script_type())
            if multi := desc.get_simple_multisig():
                multisig = self._make_multisig(multi)
            else:
                multisig = None
    ...
    def get_tx(self, tx_hash):
        ...
        return self.bitraam_tx_to_txtype(tx)
