...
Secret backup plug-in for the bitraam wallet.
...
if TYPE_CHECKING:
    from bitraam.gui.qt import BitraamGui
        ...
        if not calibration_sheet:
            if is_cseed: #its a secret
                ...
                painter.drawImage(((total_distance_h))+11, ((total_distance_h))+11,
                                  QImage(internal_plugin_icon_path(self.name, 'bitraamb.png')).scaledToWidth(round(2.1*total_distance_h), Qt.TransformationMode.SmoothTransformation))
