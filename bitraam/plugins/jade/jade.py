...
#if LOGGING:
#    logger = logging.getLogger('bitraam.plugins.jade.jadepy.jade')
#    logger.setLevel(LOGGING)
#    device_logger = logging.getLogger('bitraam.plugins.jade.jadepy.jade-device')
...
def _register_multisig_wallet(wallet, keystore, address):
    ...
    # NOTE: bitraam multisigs appear to always be sorted-multisig
