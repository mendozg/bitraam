# ----------------------------------------------------------------------------------
# Bitraam plugin for the Digital Bitbox hardware wallet by Shift Devices AG
# digitalbitbox.com
#
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def get_xpub(self, bip32_path, xtype):
        ...
        if reply:
            ...
            if xtype != 'standard' or constants.net.TESTNET:
                node = BIP32Node.from_xkey(xpub, net=constants.BitraamMainnet)
    ...
    def check_device_dialog(self):
        ...
        if not self.setupRunning:
            self.isInitialized = True # Wallet exists. Bitraam code later checks if the device matches the wallet
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Bitraam-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
    ...
    def sign_transaction(self, tx, password):
        ...
        try:
            ...
            for i, txin in enumerate(tx.inputs()):
                ...
                assert desc
                if desc.to_legacy_bitraam_script_type() != 'p2pkh':
