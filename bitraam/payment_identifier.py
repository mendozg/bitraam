...
from .bip21 import parse_bip21_URI, InvalidBitraamURI, LIGHTNING_URI_SCHEME, BITCOIN_BIP21_URI_SCHEME
...
class PaymentIdentifierState(IntEnum):
    ...
    AVAILABLE = 2           # PI contains a payable destination
                            ...
                            # of the channels Bitraam supports (on-chain, lightning)
