...
# Bitraam wallet file password. As it is pure-python and runs in the CPU,
...
#                          only the Bitraam private keys themselves are encrypted.
...
# Storage-encryption was introduced in Bitraam 2.8, keystore-encryption predates that.
# Newly created wallets in modern Bitraam have storage-encryption enabled by default.
#
