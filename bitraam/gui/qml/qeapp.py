...
class QEAppController(BaseCrashReporter, QObject):
    ...
    def __init__(self, qeapp: 'BitraamQmlApplication', plugins: 'Plugins'):
    ...
    def doNotify(self, wallet_name, message):
        ...
        try:
            ...
            notification.notify('Bitraam', message, app_icon=icon, app_name='Bitraam')
        except ImportError:
...
class BitraamQmlApplication(QGuiApplication):
    ...
    def __init__(self, args, *, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        qmlRegisterType(QEAmount, 'org.bitraam', 1, 0, 'Amount')
        qmlRegisterType(QEBytes, 'org.bitraam', 1, 0, 'Bytes')
        qmlRegisterType(QENewWalletWizard, 'org.bitraam', 1, 0, 'QNewWalletWizard')
        qmlRegisterType(QETermsOfUseWizard, 'org.bitraam', 1, 0, 'QTermsOfUseWizard')
        qmlRegisterType(QEServerConnectWizard, 'org.bitraam', 1, 0, 'QServerConnectWizard')
        qmlRegisterType(QEFilterProxyModel, 'org.bitraam', 1, 0, 'FilterProxyModel')
        ...
        qmlRegisterType(QETxFinalizer, 'org.bitraam', 1, 0, 'TxFinalizer')
        qmlRegisterType(QEPIResolver, 'org.bitraam', 1, 0, 'PIResolver')
        qmlRegisterType(QEInvoice, 'org.bitraam', 1, 0, 'Invoice')
        qmlRegisterType(QEInvoiceParser, 'org.bitraam', 1, 0, 'InvoiceParser')
        qmlRegisterType(QEAddressDetails, 'org.bitraam', 1, 0, 'AddressDetails')
        qmlRegisterType(QETxDetails, 'org.bitraam', 1, 0, 'TxDetails')
        qmlRegisterType(QEChannelOpener, 'org.bitraam', 1, 0, 'ChannelOpener')
        qmlRegisterType(QELnPaymentDetails, 'org.bitraam', 1, 0, 'LnPaymentDetails')
        qmlRegisterType(QEChannelDetails, 'org.bitraam', 1, 0, 'ChannelDetails')
        qmlRegisterType(QESwapHelper, 'org.bitraam', 1, 0, 'SwapHelper')
        qmlRegisterType(QERequestDetails, 'org.bitraam', 1, 0, 'RequestDetails')
        qmlRegisterType(QETxRbfFeeBumper, 'org.bitraam', 1, 0, 'TxRbfFeeBumper')
        qmlRegisterType(QETxCpfpFeeBumper, 'org.bitraam', 1, 0, 'TxCpfpFeeBumper')
        qmlRegisterType(QETxCanceller, 'org.bitraam', 1, 0, 'TxCanceller')
        qmlRegisterType(QETxSweepFinalizer, 'org.bitraam', 1, 0, 'SweepFinalizer')
        qmlRegisterType(QEBip39RecoveryListModel, 'org.bitraam', 1, 0, 'Bip39RecoveryListModel')
        qmlRegisterType(FeeSlider, 'org.bitraam', 1, 0, 'FeeSlider')
        # TODO QT6: these were declared as uncreatable, but that doesn't seem to work for pyqt6
        # qmlRegisterUncreatableType(QEAmount, 'org.bitraam', 1, 0, 'Amount', 'Amount can only be used as property')
        # qmlRegisterUncreatableType(QENewWalletWizard, 'org.bitraam', 1, 0, 'QNewWalletWizard', 'QNewWalletWizard can only be used as property')
        # qmlRegisterUncreatableType(QEServerConnectWizard, 'org.bitraam', 1, 0, 'QServerConnectWizard', 'QServerConnectWizard can only be used as property')
        # qmlRegisterUncreatableType(QEFilterProxyModel, 'org.bitraam', 1, 0, 'FilterProxyModel', 'FilterProxyModel can only be used as property')
        # qmlRegisterUncreatableType(QSortFilterProxyModel, 'org.bitraam', 1, 0, 'QSortFilterProxyModel', 'QSortFilterProxyModel can only be used as property')
        ...
        self.context.setContextProperty('BUILD', {
            'bitraam_version': version.ELECTRUM_VERSION,
