...
Pane {
    ...
    property var _baseunits: ['BRM','mBRM','bits','sat']
                            ...
                            if (activeFocus) {
                                if (Config.language != currentValue) {
                                    ...
                                    var dialog = app.messageDialog.createObject(app, {
                                        text: qsTr('Please restart Bitraam to activate the new GUI settings')
                                    })
                                    dialog.open()
                                }
                            }
                                ...
                                if (activeFocus) {
                                    if (!checked) {
                                        var dialog = app.messageDialog.createObject(app, {
                                            ...
                                            text: qsTr('Bitraam will have to download the Lightning Network graph, which is not recommended on mobile.'),
                                            yesno: true
                                        })
                                        dialog.accepted.connect(function() {
