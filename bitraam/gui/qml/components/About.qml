...
Pane {
    ...
    property string title: qsTr("About Bitraam")
        ...
        GridLayout {
            ...
            Item {
                ...
                Image {
                    ...
                    width: parent.width
                    height: width
                    source: '../../icons/bitraam_presplash.png'
                }
            }
            ...
            Label {
                text: qsTr('<a href="https://bitraam.org">https://bitraam.org</a>')
            ...
            Label {
                text: qsTr('Distributed by Bitraam Technologies GmbH')
                Layout.columnSpan: 2
                Layout.alignment: Qt.AlignHCenter
            }
        }
