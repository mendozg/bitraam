...
class BitraamGui(BaseBitraamGui, EventListener):
    ...
    def __init__(self, *, config, daemon, plugins):
        ...
        if not storage.file_exists():
            print("Wallet not found. try 'bitraam create'")
            exit()
    ...
    def network_dialog(self):
        print("use 'bitraam setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'bitraam setconfig' to change your settings")
        return True
