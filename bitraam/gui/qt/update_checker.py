...
class UpdateCheck(QDialog, Logger):
    url = "https://bitraam.org/version"
    download_url = "https://bitraam.org/#download"
    ...
    def __init__(self, *, latest_version=None):
        ...
        self.setWindowTitle('Bitraam - ' + _('Update Check'))
    ...
    def update_view(self, latest_version=None):
        if latest_version:
            ...
            if self.is_newer(latest_version):
                ...
                self.detail_label.setText(_("You are already on the latest version of Bitraam."))
        else:
            self.heading_label.setText('<h2>' + _("Checking for updates...") + '</h2>')
            self.detail_label.setText(_("Please wait while Bitraam checks for available updates."))
