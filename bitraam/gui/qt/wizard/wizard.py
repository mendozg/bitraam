...
from bitraam.gui.qt.util import Buttons, icon_path, MessageBoxMixin, WWLabel, ResizableStackedWidget, AbstractQWidget
...
class QEAbstractWizard(QDialog, MessageBoxMixin):
    ...
    def __init__(self, config: 'SimpleConfig', app: 'QBitraamApplication', *, start_viewstate: 'WizardViewState' = None):
    ...
    def update(self):
        ...
        icon = page.params.get('icon', icon_path('bitraam.png'))
        if icon:
