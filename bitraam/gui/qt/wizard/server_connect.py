...
class QEServerConnectWizard(ServerConnectWizard, QEAbstractWizard):
    ...
    def __init__(self, config: 'SimpleConfig', app: 'QBitraamApplication', plugins: 'Plugins', daemon: 'Daemon', parent=None):
...
class WCWelcome(WizardComponent):
    def __init__(self, parent, wizard):
        ...
        self.wizard_title = _('Bitraam Bitcoin Wallet')
        ...
        self.config_server_w = QCheckBox(_('Select Bitraam Server'))
