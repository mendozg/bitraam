...
# these are ~duplicated from run_bitraam:
is_bundle = getattr(sys, 'frozen', False)
is_local = not is_bundle and os.path.exists(os.path.join(os.path.dirname(os.path.dirname(__file__)), "bitraam.desktop"))

# when running from source, on Windows, also search for DLLs in inner 'bitraam' folder
