...
class SimpleConfig(Logger):
    ...
    NETWORK_AUTO_CONNECT = ConfigVar(
        ...
        long_desc=lambda: _("If auto-connect is enabled, Bitraam will always use a server that is on the longest blockchain. "
                            "If it is disabled, you have to choose a server you want to use. Bitraam will warn you if your server is lagging."),
    )
    NETWORK_ONESERVER = ConfigVar(
        ...
        long_desc=lambda: _(
            ...
            "\n\n"
            "By default, Bitraam tries to maintain connections to ~10 servers. "
