#!/usr/bin/python3
# For usage in shell, to get the version of bitraam, without needing bitraam installed.
# usage: ./print_bitraam_version.py [<attr_name>]
#
# For example:
# $ VERSION=$("$CONTRIB"/print_bitraam_version.py)
# instead of
# $ VERSION=$(python3 -c "import bitraam; print(bitraam.version.ELECTRUM_VERSION)")
