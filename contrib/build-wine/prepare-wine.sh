...
KEYRING_PYTHON_DEV="keyring-bitraam-build-python-dev.gpg"
...
(
    ...
    echo "const char *bitraam_tag = \"tagged by Electrum@$ELECTRUM_COMMIT_HASH\";" >> ./bootloader/src/pyi_main.c
    pushd bootloader
